...
const SAMPLE_PROPERTIES = [
  {
    ...
    highlights: '獨立套房，生活機能完善，可申請租屋補助，歡迎養貓的租客，水電使用台電台水。',
    tags: ['可租補', '可貓', '台水', '台電', '網路'],
    pros: '• 租金實惠，可申請租屋補助\n• 可養貓，寵物友善環境\n• 台水台電，費用透明\n• 網路已安裝，立即可用\n• 鄰近大坑休閒區，環境清幽',
    cons: '• 坪數較小，適合單身或一人居住\n• 無附車位，需自行尋找停車',
    images: [],
    coverIndex: 0,
  ...
  },
  {
    ...
    highlights: '電梯大樓一房一廳，生活機能極佳，有車位，陽台採光好，配備變頻冷氣。',
  ...
  },
  {
    ...
    highlights: '兩房一廳，空間寬敞，可以開伙做飯，有獨立洗曬空間，台水台電費用透明，適合家庭或室友合租。',
    tags: ['可開伙', '獨洗曬', '台水', '台電', '陽台'],
  ...
  },
  {
    ...
    highlights: '一房一廳，採光良好，可養狗可養貓，有大陽台，適合愛好寵物的租客，鄰近大學生活圈。',
    tags: ['可狗', '可貓', '陽台', '網路'],
    pros: '• 寵物友善，可養狗可養貓\n• 大陽台，適合寵物活動\n• 鄰近大學，生活機能方便\n• 採光充足，室內明亮\n• 周邊餐廳夜市選擇多',
    cons: '• 公寓無電梯，需爬樓梯（4樓）\n• 坪數適中，大型寵物需評估',
    images: [],
  ...
  },
  {
    ...
    highlights: '三房兩廳透天住宅，有附設停車位，社區設有管理室，衛浴乾濕分離，適合家庭居住，空間寬敞舒適。',
  ...
  },
  {
    ...
    size: 7,
    type: '套房',
    nearbyLandmarks: '崇德路商圈、太平區公所、太平高工、新光三越太平店',
    highlights: '全新裝修套房，月租含管理費及網路飲水機，生活費用簡單，適合上班族或學生，安靜舒適。',
    tags: ['飲水機', '網路', '台水', '台電', '變頻冷氣'],
    pros: '• 租金含管理費及網路、飲水機，費用簡單透明\n• 全新裝修，入住即可使用\n• 台水台電，計費透明\n• 變頻冷氣省電\n• 環境安靜，適合上班族或學生',
    cons: '• 坪數較小，適合單身居住\n• 距台中市中心較遠，建議有自備車輛',
    images: [],
    coverIndex: 0,
    isActive: true,
